...
# Prototype Rust — référence historique
...
Cette page conserve la présentation de la base Rust publiée au 6 septembre 2026.
La direction de production actuelle est [Unreal Engine](../README.md). Les images et
fonctionnalités ci-dessous documentent uniquement le prototype Rust.
