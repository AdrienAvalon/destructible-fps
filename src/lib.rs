...
pub use network::{
    ...
    MAX_APPLICATION_DATAGRAM_BYTES, MAX_NETWORK_EXPLOSION_PEAK_ENERGY,
    MAX_NETWORK_EXPLOSION_RADIUS_VOXELS, MAX_NETWORK_EXPLOSION_REACH_UM,
    MAX_OUTBOUND_DATAGRAMS_PER_TICK, MAX_QUEUED_COMMANDS, MAX_QUEUED_REPAIRS,
